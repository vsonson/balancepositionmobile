...
@Component({
  moduleId: module.id,
  selector: 'refer-modal',
  templateUrl: './referModal.component.html',
  styleUrls: ['./referModal.component.scss']
})
export class ReferModalComponent implements OnInit, OnDestroy {
